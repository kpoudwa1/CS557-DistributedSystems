...
public class Server
{
	...
	public static void main(String[] args) 
	{
		try
		{
			if(args.length != 1)
			{
				System.err.println("Error: Incorrect number of arguments. Program accepts 1 argument.");
				System.exit(0);
			}
			
			handler = new FileStoreHandler(Integer.valueOf(args[0]));
	...
	public static void simple(@SuppressWarnings("rawtypes") FileStore.Processor processor)
	{
	    try
	    {
	...
	public static void secure(@SuppressWarnings("rawtypes") FileStore.Processor processor) {
	    try {
	      /*
